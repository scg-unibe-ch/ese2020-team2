...
/**
 * This controller is to add, delete and update the reviews to the review model.
 * It also uodates the avegare product ratings of the product when a new review is added.
 */
...
/**
 * Returns a particular product with the review id.
 */
...
/**
 * Returns all the reviews of a particular user as buyer for different product.
 */
...
/**
 * Returns all the reviews of a particular user as seller for different product.
 */
...
/**
 * Returns all the reviews of a particular product.
 */
